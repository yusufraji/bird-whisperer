...
A repo for the project bird-whisperer.
...
```
    ...
    │                         `2022-01-01-jqp-initial-data-exploration`
    │
...
- in the project directory `bird-whisperer` run `virtualenv --python=/usr/local/bin/python3 venv`
